...
/* harmony default export */ var DropdownHandler = ({
  ...
  computed: {
    ...
    actionClasses: function actionClasses() {
      return [!this.nav && 'btn', !this.nav && prefix_prefix(this.size, 'btn'), !this.nav && prefix_prefix(this.variant, 'btn')].filter(function (value) {
        return !!value;
      }).join(' ');
    },
    ...
    toggleClasses: function toggleClasses() {
      return [!this.nav && 'btn', 'dropdown-toggle', !this.nav && this.variantClass, !this.nav && this.sizeableClass, this.active ? 'active' : '', !this.nav && this.block ? 'btn-block' : '', !this.split && this.circle ? 'rounded-circle' : '', !this.split && this.rotate && this.isDropdownShowing ? 'rotate-90' : '', this.split ? 'dropdown-toggle-split' : ''].filter(function (value) {
        return !!value;
      }).join(' ');
    }
  },
